...
public class App {
	...
	public static void main(String[] args) {
		...
		String res = SignIn.signIn();
		if (res != null) {
			System.out.println("Sign in successfull with user: " + res);
			while (true) {
				int customerChoice;
				int contractChoice;
				int dashBoardChoice;
				...
				case 1:
					while (true) {
						...
						/*---------------------Manage Customer------------------*/
						case 1:
							if (customerServices.addCustomer(Menu.readCustomerDetails())) {
					...
					while (true) {
						...
						case 2:
							...
							if (landServices.updateLandRecord(landId, landTax)) {
								System.out.println("Customer with ID: " + landId
										+ " has been updated with new Tax of rupees: " + landTax);
							} else {
			...
			System.err.println("Invalid User....contact admin at +91 80 5554440/ 41/ 42");
		}
	}
}
