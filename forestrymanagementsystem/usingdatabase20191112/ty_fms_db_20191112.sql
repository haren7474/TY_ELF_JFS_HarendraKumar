...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2019 at 10:15 AM
...
(5001, 501, 200, '2019-12-09 16:59:11'),
...
(1003, 'Rubber', 18, 13, 'For short period use only.', 3),
(1004, 'Glue', 15, 3, 'For use with notebooks only.', 4),
(1005, 'Banana', 32, 20, 'Use within a month.', 3),
...
--
ALTER TABLE `billing`
  MODIFY `bill_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5009;

--
-- AUTO_INCREMENT for table `contract`
--
ALTER TABLE `contract`
  MODIFY `contract_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=505;

--
-- AUTO_INCREMENT for table `land`
--
ALTER TABLE `land`
  MODIFY `land_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5006;
