...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (user != null) {
			...
			out.println("<br><a href='./addUser.html'>Add User</a>");
			out.println("<br><a href='./updateUser.html'>Update User</a>");
			out.println("<br><a href='./searchUser.html'>Search Users</a>");
			out.println("<br><a href='./deleteUser.html'>Delete Users</a>");
			out.println("<br><a href='./displayAllUsers.html'>View All Users</a>");
